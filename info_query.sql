...
DUMMY8 AS Bus_Org,
DUMMY1 as RISK_ASSESSMENT_TYPE,
DUMMY2 as RELATED_RISKS,
...
CAL_RES_RISK_RATING as CAL_RES_RISK_RATING,
IS_RES_OVERRIDEN as IS_RES_OVERRIDEN,
FINAL_RESIDUAL_RATING as FINAL_RESIDUAL_RATING,
RESIDUAL_TREND as RESIDUAL_TREND,
DUMMY15 as is_residual_risk_within
,DUMMY3 as A_TAXONOMY_ASSESSMENT_HAS_THER
,ASSMNT_DUE_DATE
,ASSESSED_ON
,ASSESSED_BY
